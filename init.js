...
// honda.insertMany(hondaCars);
// tata.insertMany(tataCars);
// hyundai.insertMany(hyundaiCars);
// renault.insertMany(renaultCarsCars);
// maruthi.insertMany(maruthiCars);
...
async function main() {
  try {
    ...
    // Close the MongoDB connection after inserting documents
    mongoose.disconnect();
  }
}
